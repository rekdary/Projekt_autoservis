"use strict";
// Ceník / seznam provedených úkonů na zakázce (přístupný globálně)
const surovaDataZakazky = [
    ...
    { typ: "prace", nazev: "Seřízení geometrie", cena: 900, hodiny: 1.2 },
    { typ: "prace", nazev: "Výměna spojky", cena: 1200, hodiny: 5.5 },
    { typ: "prace", nazev: "Servis klimatizace", cena: 700, hodiny: 1.8 },
    { typ: "prace", nazev: "Výměna rozvodů", cena: 1500, hodiny: 7 },
    // MATERIÁL
    ...
    { typ: "material", nazev: "Vzduchový filtr", cena: 420, mnozstvi: 1, marze: 1.25 },
    { typ: "material", nazev: "Žárovka H7", cena: 180, mnozstvi: 2, marze: 1.5 },
    { typ: "material", nazev: "Brzdová kapalina", cena: 220, mnozstvi: 1, marze: 1.35 },
    { typ: "material", nazev: "Akumulátor 12V", cena: 3100, mnozstvi: 1, marze: 1.12 }
];
